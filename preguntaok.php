...
$result;	
$conn = dbConnect();
$query = "INSERT INTO preguntas (idv, idu, pregunta, respondido) VALUES ('$_POST[idviaje]', '$_SESSION[email]', '$_POST[descripcion]', 'no')";
$conn->query($query);
?>
...
<html>
 ...
 <body>
	...
	<p><h1>Pregunta registrada!</p></h1>
	<p><h2><a href="postulate.php?">Postularse</p></h2>
