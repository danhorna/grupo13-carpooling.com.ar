...
if(isset($_POST['bi'])){
	$query = "UPDATE postulaciones SET calificadoco = 'si' WHERE id = '$_POST[bp]'";
	$conn->query($query);
	...
	if (isset($_POST['mi'])) {
		$query = "UPDATE postulaciones SET calificadoco = 'si' WHERE id = '$_POST[mp]'";
		$conn->query($query);
		...
		$query = "UPDATE postulaciones SET calificadoco = 'si' WHERE id = '$_POST[np]'";
		$conn->query($query);
	}
}
