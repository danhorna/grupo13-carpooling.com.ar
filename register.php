...
<html>
 ...
 <body>
	...
	<div id="page" class="container">
		<div class="title">
			<h2>Registrarse a Carpooling</h2>
		</div>
	</div>
	</div>
	<div class="wrapper">
	<div id="three-column" class="container">
		<p><h3><font color="red">Los opciones marcadas con * son obligatorias</font></h3></p>
			<form action="complete.php" method="post" onsubmit="return validacion()">
			...
			<p><h4>Fecha de nacimiento<font color="red">(*)</font>: <input type="date" name="edad" id="edad" min="1928-01-01" max="2000-12-31"/></h4></p>
